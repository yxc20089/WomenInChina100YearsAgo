...
| NER | Rules + MacBERT/MacBERT-DAPT/mmBERT/GujiRoBERTa/SIKU W2NER tournament; gated GLiNER-X recall union; NuExtract3 difficult-case challenger | Multi-run benchmark harness and issue-cluster comparator implemented; mmBERT tokenizer test and all supervised training pending; PP-UIE assistance/other rights-blocked arms excluded from automatic union; no winner |
