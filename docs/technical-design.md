...
| Model handoff | OpenAI-compatible adapter with prompt hashing and untrusted-OCR/history boundary | One-turn briefs/scenes and bounded multi-turn research chat implemented; live model not configured; scene generation abstains without reviewed claims |
